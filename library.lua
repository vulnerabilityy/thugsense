    ...
    local Library do
        ...
        Library = {
            ...
            Folders = {
                Directory = "chudvision.net",
                Configs = "chudvision.net/Configs",
                Assets = "chudvision.net/Assets",
                Songs = "chudvision.net/Songs"
            },
        ...
        Library.CreateKeybind = function(self, Data)
            ...
            function Keybind:Set(Key)
                if typeof(Key) == "EnumItem" or (type(Key) == "string" and StringFind(Key, "Enum")) then 
                    Keybind.Key = tostring(Key)

                    local KeyName = typeof(Key) == "EnumItem" and Key.Name or StringGSub(Key, ".*%.", "")
            ...
            elseif TableFind({"Toggle", "Hold", "Always"}, Key) then 
                ...
                elseif type(Key) == "table" then 
                    ...
                    local KeyName = typeof(RealKeyEnum) == "EnumItem" and RealKeyEnum.Name or StringGSub(tostring(RealKeyEnum), ".*%.", "")
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            function Toggle:Set(Bool)
                Toggle.Value = (Bool == nil and not Toggle.Value or Bool)
